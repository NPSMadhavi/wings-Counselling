...
export default function AnxietyArticlePage() {
  ...
  const generatePDF = async (mode = "download") => {
    ...
    const titleLines = doc.splitTextToSize("GRIEF - a hidden crisis?", contentWidth - 10);
    let titleY = 22;
    ...
    const subtitle = "Grief is a natural reaction to loss. It can arise from many kinds of meaningful loss and may affect emotions, physical health, and daily life.";
            ...
            <aside className="sidebar-scroll w-full lg:w-[220px] self-start max-h-[calc(100vh-8rem)] overflow-y-auto overflow-x-hidden" style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              <div>
                ...
                <div className="text-[16px] leading-[190%] text-[#595550]">
                  <p>
                    By Dr. Elena Morris · Relationship expert
                  </p>
                </div>
            ...
            <main ref={mainContentRef} className="sidebar-scroll w-full lg:self-stretch lg:overflow-y-auto" style={{ scrollBehavior: 'smooth', scrollbarWidth: 'none', msOverflowStyle: 'none' }}>
              ...
              >
                ...
                <div className="mt-7 space-y-6 text-[18px] leading-[210%] text-[#3D3935]">
                  <p>
                    Grief is a natural reaction, a kind of acute pain that accompanies a loss.
                    However, this reaction is not only limited to the loss of a loved one.
                    It can also arise from the loss of a treasured pet, a position in society,
                    a job, or a relationship that was meaningful.
                  </p>

                  <p>
                    Because grief reflects what or who we love, when something or someone we
                    love is taken away, it can feel overwhelmingly painful or all-encompassing.
                    Sometimes the same pain can become complex when a person does not have the
                    opportunity or space to experience the pain fully because of overwhelming
                    responsibilities around them.
                  </p>
                </div>
              </motion.div>
              ...
              <section id="what-grief-feels-like" className="mt-[72px]">
                ...
                <div className="mt-7 space-y-6 text-[18px] leading-[210%] text-[#3D3935]">
                  <p>
                    In grief, one may experience all kinds of difficult and unexpected emotions,
                    ranging from shock or anger to disbelief, guilt, and profound sadness.
                  </p>

                  <p>
                    The pain of grief can disrupt physical health, making it difficult to sleep,
                    eat, or even think straight. These are normal reactions to loss, and the more
                    significant the loss, the more intense the grief may feel.
                  </p>

                  <p>
                    The grief experience and the grief process are common occurrences interwoven
                    throughout our lives. The intensity and duration of grief depends on one’s
                    personal reaction to a particular loss. Every crisis involves an element of
                    grief because crisis often involves loss, and loss results in grief.
                  </p>
                </div>
              </section>
              ...
              <section id="losses-that-cause-grief" className="mt-[72px]">
                ...
                <div className="mt-7 space-y-6 text-[18px] leading-[210%] text-[#3D3935]">
                  <p>
                    People may associate grieving with the death of a loved one, which is often
                    the cause of the most intense type of grief. However, any meaningful loss can
                  ...
                  <p>
                    Even subtle losses in life can trigger grief. For example, one might grieve
                    after moving away from an ancestral home or changing jobs.
                  </p>
                </div>
              </section>
              ...
              <section id="when-life-becomes-heavy" className="mt-[72px]">
                ...
                <div className="mt-7 space-y-6 text-[18px] leading-[210%] text-[#3D3935]">
                  <p>
                    Firstly, taking care of one’s own self is important even when grieving.
                    You may experience difficulty sleeping or a lack of motivation, but having
                    a healthy diet, maintaining exercise, and keeping a hygienic routine are
                    important for emotional healing.
                  </p>

                  <p>
                    Time can be the best healer in many cases, but there are other avenues of
                    help as well. Speaking to a trusted friend or relative about overwhelming
                    experiences can help a person feel less alone.
                  </p>
                </div>
              </section>
              ...
              <section id="getting-support" className="mt-[72px]">
                ...
                <div className="mt-7 space-y-6 text-[18px] leading-[210%] text-[#3D3935]">
                  <p>
                    One can also seek assistance from a trained counsellor who understands that
                    whatever your loss may be, it is personal and unique to you. Counselling can
                    help you process the loss in a safe and supportive space.
                  </p>

                  <p>
                    Although not everyone will need counselling, if someone is experiencing
                    intense grief for a long time after the loss, counselling may indeed be
                    necessary.
                  </p>
                </div>
              </section>
              ...
              <section id="final-thought" className="mt-[72px]">
                ...
                <div className="mt-7 space-y-6 text-[18px] leading-[210%] text-[#3D3935]">
                  <p>
                    Whatever it is, there is no need to feel scared or ashamed about how you feel,
                    or to believe that it is strange to behave or feel the way you are feeling.
                  </p>

                  <p>
                    Instead, believe that in time to come, you can come to terms with your loss,
                    find new meaning, and eventually move on with your life. Temporarily, you may
                    feel disoriented, numb, or empty, and it is okay to need help from others.
                  </p>
                </div>
              </section>
