const DEFAULT_BULLETS = [
  "Support for children, youths, individuals, couples, and families",
  "Confidential and professional counselling services",

];

const THERAPY_BULLETS = [
...
export const individualTherapy = {
  serviceLabel: "Individual therapy",
  sectionTitle: "How individual therapy helps",
  teamKeywords: ["individual", "therapy", "counselling", "adult", "stress"],
  description:
...
export const familySupport = {
  ...
  imageAlt: "Family support & Counselling program",
  backHash: "counselling",
};

export const maritalTherapy = {
  serviceLabel: "Marital & Couple therapy",
  sectionTitle: "How marital & couple therapy helps",
...
export const preschoolChildren = {
  serviceLabel: "Pre-school children",
  sectionTitle: "How pre-school children helps",
...
export const youthCounselling = {
  serviceLabel: "Youth",
  sectionTitle: "How youth counselling helps",
  teamKeywords: ["youth", "adolescent", "school", "student", "teen"],
  description:
 ...
 bulletPoints: [
  ...
  imageAlt: "Youth counselling",
  backHash: "counselling",
};

export const adultCounselling = {
  serviceLabel: "Adults",
  sectionTitle: "How adult counselling helps",
  teamKeywords: ["adult", "individual", "counselling", "therapy"],
  description:
    "The friendly counsellors at WINGS Counselling Centre provide assistance to individuals and adults who may be experiencing a variety of personal issues such as work stress, relationship difficulties, transitional challenges or family and personal dilemmas. Our counsellors are specially trained to employ a range of techniques based on systemic communication, experiential relationship building, therapeutic dialogue, cognitive-behavioural therapy and expressive therapy to help clients create meaningful changes in their lives that elevate and improve their overall well-being, while facilitating the quality of their relationship with significant others.",
  bulletPoints: DEFAULT_BULLETS,
  therapyImage: "/assets/counselling6.jpg",
  imageAlt: "Adult counselling",
  backHash: "counselling",
};

export const clinicalSupervision = {
  serviceLabel: "Supervision",
  appointmentSelection: {
    counsellingTypeName: "Supervision",
    subTypeName: "Supervision",
  },
  sectionTitle: "How supervision helps",
...
export const schoolOutreach = {
  ...
  therapyImage: "/assets/training.jpg",
  imageAlt: "School outreach programmes",
  backHash: "training",
};

export const workplaceWellness = {
  serviceLabel: "Workplace wellness workshops",
  appointmentSelection: trainingAppointmentSelection,
  sectionTitle: "How workplace wellness workshops helps",
...
export const communityProgrammes = {
  serviceLabel: "Community organisation programmes",
  appointmentSelection: trainingAppointmentSelection,
  sectionTitle: "How community organisation programmes helps",
...
export const familyParenting = {
  serviceLabel: "Family & Parenting",
  sectionTitle: "How family & parenting counselling helps",
...
export const skillParenting = {
  serviceLabel: "Skill-based parenting workshops",
  appointmentSelection: trainingAppointmentSelection,
  sectionTitle: "How skill-based parenting workshops helps",
